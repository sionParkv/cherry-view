                  ...
                  <Box className="Gender">
                    <Box
                      ...
                      sx={{
                        ...
                        color:
                          selectedGender === 'male' ? '#202020' : '#c4c4c4',
                        cursor: 'pointer',
                      }}
                    >
                      남성
                    ...
                    <Box className="TwoContent">
                      <Box
                        ...
                        sx={{
                          ...
                          color:
                            selectedFace === 'face' ? '#202020' : '#c4c4c4',
                          cursor: 'pointer',
                        }}
                      >
                        노출
      ...
      <Box className="MobileBox">
        <Box className="MobileDisplay">
          ...
          <Box className="CampInfo">
            ...
            <Box className="DetailSection"></Box>
            <T className="DetailText">영업시간 및 방문 가능일정</T>
            <Box className="InfoBox">
              [영업시간] 화~일 17:00~23:30 (L.O 22:30) / 월요일 휴무
              <br />
              [인플루언서 방문가능일정] 화~금 17:00~23:30 (L.O 22:30)
          ...
          <Box className="CampInfo">
            ...
            <Box className="MediaText">
              ...
              · 등록한 미디어는 선정 후 변경할 수 없습니다.
              <br />
              · 블로그에 전체 공개, 검색 허용이 체크된 포스팅이 1개 이상 있어야
              합니다.
              <br />
          ...
          <Box className="CampInfo">
            ...
            <Box className="InstaText">
              01. 인스타그램을 프로페셔널 계정으로 전환합니다.
            </Box>
            <img className="InstaImg" src={images.mobileInsta1} />
            <Box className="MobileGuide">
              <Box>01</Box>
              <T>인스타그램</T>
            </Box>
            <Box className="MobileGiudes">
              01 설정 및 개인정보 ＞ 계정 유형 도구
            </Box>
            <img className="InstaImg" src={images.mobileInsta1} />
            <Box className="MobileGuide">
              <Box>02</Box>
          ...
          <Box className="CampInfo">
            ...
            <Box className="DetailSection" />
            <T className="MobileText2">이름*</T>
            <TextField label="이름을 작성해주세요" defaultValue="" />
            <Box className="DetailSection" />
            <T className="MobileText2"> 연락처*</T>
            <TextField label="예)01012345678" defaultValue="" />
            <Box className="DetailSection" />
            <T className="MobileText2">주소*</T>
          </Box>
          <Box className="Section" />
        ...
        <Button className="MobileButton">콘텐츠 제출하기</Button>
      </Box>
      <components.Footer />
    </Container>
  )
